-- Event-Driven Architecture Schema for Supabase (PostgreSQL)
...
-- Enable Realtime for events table so projections can react instantly
ALTER PUBLICATION supabase_realtime ADD TABLE events;

-- 2. Projections (State derived from events)
