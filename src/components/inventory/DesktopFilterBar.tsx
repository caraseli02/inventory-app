...
export const DesktopFilterBar = ({
  ...
  return (
    <div className="rounded-2xl border-2 border-stone-200 bg-white/90 shadow-sm p-4 space-y-4">
      ...
      <div className="flex items-end gap-3 flex-wrap">
        ...
        <div className="w-[170px] space-y-1">
          ...
          >
            <SelectTrigger className="w-full h-10 border-2 border-stone-300">
        ...
        <div className="w-[170px] space-y-1">
          <span className="text-[11px] font-semibold uppercase tracking-wide text-stone-500">
            {t('inventory.filters.sortBy', 'Sort by')}
          </span>
          <SortToggle
      ...
      <div className="flex items-center justify-end gap-2 border-t-2 border-stone-200 pt-3">
        {/* Import Excel Button */}
        <Button
          size="sm"
          onClick={onImport}
