  ...
  return (
    <div className="group bg-white border-2 border-stone-200 rounded-lg p-4 transition-all duration-200 hover:shadow-lg hover:-translate-y-1">
      <div className="flex gap-4 items-center">
        ...
        {/* Quantity Controls - Enhanced with hover states */}
        <div
          className="flex items-center gap-3 bg-stone-50 border-2 border-stone-200 rounded-lg px-2 py-1 transition-colors"
          style={{
