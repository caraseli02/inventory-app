...
function ScannerViewport({ scannerId, onScanSuccess, isLoading, loadingText }: ScannerViewportProps): React.ReactElement {
  return (
      ...
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center bg-white/90 backdrop-blur-sm z-20">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-stone-900 text-sm font-medium">{loadingText}</p>
          </div>
        </div>
      )}
    </div>
    ...
    <>
      ...
      <div className="lg:hidden fixed inset-0 bg-gradient-to-br from-stone-100 to-stone-200 overflow-hidden">
        ...
        {!scannedCode && (
          <div className="px-6 pt-4 space-y-4">
            <ScannerViewport
              scannerId="add-mobile-reader"
              onScanSuccess={handleScanSuccess}
              isLoading={isLoading}
              loadingText={t('scanner.searching')}
            />
      ...
      <div className="hidden lg:block fixed inset-0 bg-gradient-to-br from-stone-100 to-stone-200">
        ...
        <div className="flex h-[calc(100dvh-64px)] gap-6 p-6">
          ...
          {/* Right Column: Panel (55% when scanner visible, 100% when product scanned) */}
